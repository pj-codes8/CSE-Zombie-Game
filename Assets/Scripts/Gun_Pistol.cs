...
{
    public float damage = 25f;                          // Gun Damage
    public float range = 85f;                          // Gun Range
    public float fireRate = 8f;                        // Gun Fire Rate
    private float nextTimeToFire = 0f;                  //
    private bool allowedToShoot;                        // Boolean to lock the player from shooting
    private int ammo_count;                             // Ammo count variable
    private int maxAmmo = 12;                           // Max ammount count variable
    private PlayerAmmo playerAmmo;          // Reference to the players ammo reserves
    private string weaponType = "Pistol";       // Weapon type identifier

    //private int reserveAmmo;                            // Ammo reserves

    //private int maxReserveAmmo = 100;                   // Max ammo Reserves
    ...
    public ParticleSystem PistolMuzzle;                  // Reference to the Muzzle FLash 
...
/*
    public void pistolAddAmmo(int ammo)
    {
        reserveAmmo += ammo;
